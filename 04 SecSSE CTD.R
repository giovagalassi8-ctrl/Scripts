...
#
# Purpose:
# Fit the parsimonious Concealed Trait-Dependent model.
#
...
#   1 = speciation rate for concealed state A
#   2 = speciation rate for concealed state B
...
#
# Outputs:
#   analyses/SSE/Terebridae_CTD_fit.rds
#   analyses/SSE/Terebridae_CTD_results.csv
# =============================================================================
...
rds_output_file <- "Conidae_CTD_fit.rds"
csv_output_file <- "Conidae_CTD_results.csv"
...
# Associate the two speciation rates with concealed states.
