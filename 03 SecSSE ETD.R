...
#
# Purpose:
# Fit the parsimonious Examined Trait-Dependent model.
#
# Required trait CSV columns:
#   species
#   trait
#
# The trait table must contain the same species as the tree.
# Species names must use spaces in the CSV and underscores in the tree.
#
# Trait coding:
#   0 = shallow
#   1 = deep
...
#   1 = lambda for shallow species
#   2 = lambda for deep species
#   3 = one extinction rate shared across all states
#   4 = transition rate from state 0 to state 1
#   5 = transition rate from state 1 to state 0
#
# Outputs:
#   analyses/SSE/Terebridae_ETD_fit.rds
#   analyses/SSE/Terebridae_ETD_results.csv
# =============================================================================
...
rds_output_file <- "Conidae_ETD_fit.rds"
csv_output_file <- "Conidae_ETD_results.csv"
...
# Define faithful inheritance of the observed state at speciation.
...
# Create two speciation rates associated with shallow and deep states.
...
# Create the extinction-rate structure.
...
# Calculate AIC model statistics.
